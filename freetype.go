...
package freetype // import "github.com/painterQ/freetype"
...
import (
	...
	"github.com/painterQ/freetype/raster"
	"github.com/painterQ/freetype/truetype"
...
// Wentao: Calc string used pixels.
func (c *Context) StringPixelLength(s string) (int32, error) {
	var p fixed.Point26_6
	if c.f == nil {
		return 0, errors.New("freetype: DrawText called with a nil font")
	}
	prev, hasPrev := truetype.Index(0), false
	for _, rune := range s {
		index := c.f.Index(rune)
